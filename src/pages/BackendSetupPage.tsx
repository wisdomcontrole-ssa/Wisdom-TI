...
const steps = [
  {
    ...
    title: 'Banco',
    detail:
      'Aplique as migrações necessárias no Supabase SQL Editor.',
  },
  {
    icon: KeyRound,
  ...
  },
  {
    ...
    title: 'Reiniciar',
    detail:
      'Reinicie o npm run dev depois de salvar o .env.local.',
  },
]
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-2 max-w-xl text-sm leading-6 text-slate-500">
            Finalize a conexão local do Inventário TI com o projeto Supabase.
          </p>
