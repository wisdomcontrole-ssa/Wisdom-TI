    ...
    <div className="min-h-screen bg-[#f4f6f9] lg:grid lg:grid-cols-[minmax(360px,0.78fr)_1.22fr]">
      <aside className="hidden min-h-screen flex-col justify-between overflow-hidden bg-[#0b1220] p-10 lg:flex xl:p-14">
        ...
        <div className="max-w-md">
          ...
          <h1 className="text-3xl font-bold tracking-[-0.045em] text-white">Gestão de TI</h1>
          <p className="mt-3 max-w-sm text-sm leading-6 text-slate-400">
            Ambiente interno de patrimônio, estoque, auditoria e monitoramento técnico.
          </p>
        </div>
      ...
      <main className="flex min-h-screen items-center justify-center p-5 sm:p-8">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-7">
            ...
            <p className="mt-2 text-sm text-slate-500">Utilize sua conta institucional.</p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            <label className="block">
              <span className="mb-1.5 block text-xs font-semibold text-slate-700">E-mail</span>
            ...
            <label className="block">
              <span className="mb-1.5 block text-xs font-semibold text-slate-700">Senha</span>
              <div className="relative">
